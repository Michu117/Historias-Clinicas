      ...
      <div className="min-h-screen flex items-center justify-center bg-[var(--hc-bg)] p-4">
        <Card className="w-full max-w-md">
          ...
          <Link to="/seguridad/login">
            <Button variant="primary" className="w-full">Volver al inicio de sesión</Button>
          </Link>
        </Card>
      </div>
    )
    ...
    <div className="min-h-screen flex items-center justify-center bg-[var(--hc-bg)] p-4">
      <Card className="w-full max-w-md">
        <div className="text-center mb-6">
          ...
          <p className="text-sm text-[var(--on-surface-variant)] mt-1">Ingresa tu correo electrónico y te enviaremos un enlace de restablecimiento.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <Input type="email" placeholder="tu@correo.com" value={correo} onChange={(e) => setCorreo(e.target.value)} required autoFocus />
          </div>
        ...
        <p className="text-center text-sm text-[var(--on-surface-variant)] mt-4">
          <Link to="/seguridad/login" className="text-hc-primary font-medium hover:underline">Volver al inicio de sesión</Link>
        </p>
      </Card>
    </div>
  )
